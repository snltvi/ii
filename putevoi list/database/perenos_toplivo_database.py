...
LOGIN = "abvprom"
PASSWORD = "29328"
# Шлях до вашого довідника
INPUT_FILE = r'C:\Users\snltv\Desktop\ii\putevoi list\справочники\CAN_пробег_датчики_06_02_2026.xlsx' 
...
def load_month_fuel(year, month):
    ...
    if not os.path.exists(INPUT_FILE):
        print(f"❌ Файл {INPUT_FILE} не знайдено!"); return
    ...
    for day in range(1, last_day + 1):
        ...
        for _, row in df_input.iterrows():
            ...
            try:
                # Отримуємо дані про паливо
                url_f = f"{API_BASE_URL}/getobjectsfuelinfo"
                params_f = {'date_from': f"{date_str} 00:00:00", 'date_to': f"{date_str} 23:59:59", 'objuids': str(oid)}
                ...
                if res_f and len(res_f) > 0:
                    ...
                    # Шукаємо суматор або датчики палива
                    for s in sensors:
                    ...
                    # Розрахунок витрати: (Старт - Кінець + Заправки)
