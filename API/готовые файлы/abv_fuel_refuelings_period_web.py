...
def generate_report_html(vehicle_name, driver_name, period_start, period_end, fuelings):
    ...
    if not fuelings:
        ...
        min_volume = min(f['volume'] for f in fuelings)
        max_volume = max(f['volume'] for f in fuelings)
            ...
            <div class="card">
                ...
                <div class="stats">
                    ...
                    <div class="stat-card warning">
                        <div class="stat-value">{max_volume:.1f} л</div>
                        <div class="stat-label">Макс. заправка</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">{min_volume:.1f} л</div>
                        <div class="stat-label">Мин. заправка</div>
                    </div>
                </div>
                ...
                <div class="summary-box">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <div class="summary-label">Заправлено</div>
                        </div>
                        <div class="summary-item">
                        ...
                        <div class="summary-item">
                            <div class="summary-value">{avg_volume:.1f} л</div>
                            <div class="summary-label">В среднем</div>
                        </div>
                        <div class="summary-item">
                    ...
                    <p style="margin-top: 18px; font-size: 11px; color: #666; text-align: center;">* Приблизительная стоимость по 50 грн/л</p>
                </div>
                ''' if fuelings else ''}
            </div>
